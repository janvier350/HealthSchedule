...
function permisos_catalogo() {
    return [
        ...
        'agenda.atendidas'     => ['Citas atendidas (historial)',   'Agenda',        ['SISTEMA'=>1,'DOCTOR'=>1,'USUARIO'=>0,'ASISTENTE'=>0]],
        'agenda.weightplanner' => ['Planificador de peso',          'Agenda',        ['SISTEMA'=>1,'DOCTOR'=>1,'USUARIO'=>0,'ASISTENTE'=>0]],
        'agenda.notificacion'  => ['Enviar notificación (correo)',  'Agenda',        ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        // Pacientes
        'pac.eliminados'       => ['Pacientes eliminados',          'Pacientes',     ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        ...
        'pac.docenviados'      => ['Documentos enviados',           'Pacientes',     ['SISTEMA'=>1,'DOCTOR'=>1,'USUARIO'=>0,'ASISTENTE'=>0]],
        // Configuración / catálogos
        'cfg.crear_doctor'     => ['Crear doctor',                  'Configuración', ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'cfg.icd10'            => ['Catálogo ICD-10',               'Configuración', ['SISTEMA'=>1,'DOCTOR'=>1,'USUARIO'=>0,'ASISTENTE'=>0]],
        'cfg.tiposconsulta'    => ['Tipos de consulta',             'Configuración', ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'cfg.ncp'              => ['Diagnósticos NCP/PES (catálogo)','Configuración', ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'cfg.tiposseguro'      => ['Tipos de seguro',               'Configuración', ['SISTEMA'=>1,'DOCTOR'=>1,'USUARIO'=>0,'ASISTENTE'=>0]],
        // Facturación
        ...
        'fact.pagos'           => ['Registrar / anular pagos',      'Facturación',   ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'fact.billitems'       => ['Bill Items (catálogo)',         'Facturación',   ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'fact.registerbills'   => ['Registrar Bills (anterior)',    'Facturación',   ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'fact.kalix'           => ['Importar facturas (Kalix)',     'Facturación',   ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'fact.reportes'        => ['Reportes de facturación',       'Facturación',   ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
        'fact.aseguradoras'    => ['Aseguradoras (gestionar)',      'Facturación',   ['SISTEMA'=>1,'DOCTOR'=>0,'USUARIO'=>0,'ASISTENTE'=>0]],
