                        ...
                        <div class="row">                            
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-warning">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Próximas citas</div>
                                            <div class="widget-subheading">Vigentes</div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-success">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Citas atendidas</div>
                                            <div class="widget-subheading">Semana Actual </div>
                                        </div>
                                        <div class="widget-content-right">
                                    ...
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                ...
                                                <div class="widget-subheading">Vigentes-Concretadas-Negadas</div>
                                            </div>
                                            <div class="widget-content-right">
                                    ...
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                ...
                                                <div class="widget-subheading">PVP Ventas Concretadas</div>
                                            </div>
                                            <div class="widget-content-right">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Efectividad</div>
