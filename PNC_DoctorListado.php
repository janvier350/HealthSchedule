                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="fa-stethoscope icon-gradient bg-warm-flame">
                                        </i>
                                    </div>
                                    <div>Listado
                                        <div class="page-title-subheading">Dr.
                                        </div>
                                    </div>
                                </div>
                                              ...
                                              <td>
                                                <div class="d-flex align-items-center">
                                                  <img
                                                      ...
                                                      />
                                                  <div class="ms-3">
                                                    <p class="fw-bold mb-1">Cesar Mariscal</p> 
                                                    <p class="text-muted mb-0"></p>
                                                  </div>
                                                </div>
                                              </td>
                                              <td>
                                                <p class="fw-normal mb-1">Medicina General</p>
                                              ...
                                              <td>
                                                <div class="d-flex align-items-center">
                                                  <img
                                                      ...
                                                      />
                                                  <div class="ms-3">
                                                    <p class="fw-bold mb-1">Abigail Uribe</p>
                                                    <p class="text-muted mb-0"></p>
                                                  </div>
                                                </div>
                                              </td>
                                              <td>
                                                <p class="fw-normal mb-1">Dentista</p>
                                                <p class="text-muted mb-0">099-555555555</p>
                                              </td>
                                              <td>
                                              ...
                                              <td>
                                                <div class="d-flex align-items-center">
                                                  <img
                                                      ...
                                                      />
                                                  <div class="ms-3">
                                                    <p class="fw-bold mb-1">Ener Valencia</p>
                                                    <p class="text-muted mb-0"></p>
                                                  </div>
                                                </div>
                                              </td>
                                              <td>
                                                <p class="fw-normal mb-1">Nutricionista</p>
                                                <p class="text-muted mb-0">099-99999999</p>
                                              </td>
                                              <td>
                                                <span class="badge badge-success rounded-pill d-inline">Active</span>
                                              </td>
                                              ...
                                              <td>
                                                <div class="d-flex align-items-center">
                                                  <img
                                                      ...
                                                      />
                                                  <div class="ms-3">
                                                    <p class="fw-bold mb-1">Carmen Lara</p>
                                                    <p class="text-muted mb-0"></p>
                                                  </div>
                                                </div>
                                              </td>
                                              <td>
                                                <p class="fw-normal mb-1">RDN</p>
                                                <p class="text-muted mb-0">099-99999999</p>
                                              </td>
                                              <td>
