    ...
    <div class="app-main">
        ...
        <div class="app-main__outer"><div class="app-main__inner">
            ...
            <div class="page-title-actions">
                ...
                <a href="cuentas_por_cobrar.php" class="btn btn-outline-secondary btn-sm"><?php te('menu.accountsReceivable'); ?></a>
            </div>
            </div></div>
                  ...
                  <div class="modal-body">
                    <?php if (current_lang() === 'en'): ?>
                      ...
                      <ul style="line-height:1.9;">
                        <li>Open <b>Accounts Receivable</b> to see each invoice's status (paid / pending / due date).</li>
                    ...
                    <?php else: ?>
                      ...
                      <ul style="line-height:1.9;">
                        <li>Abre <b>Cuentas por Cobrar</b> para ver el estado de cada factura (pagada / pendiente / vencimiento).</li>
